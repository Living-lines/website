...
const BrandPage = () => {
  ...
  useEffect(() => {
    const brandLogos = [
      ...
      { name: 'grohe logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/grohe.png' },
      ...
      { name: 'anchor logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/anchor%20logo.png' },
      { name: 'austin logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/austin%20logo.png' },
      { name: 'cri logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/cri%20logo.png' },
      { name: 'elleys Logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/Elleye.jpg' },
      { name: 'eureka logo.jpg', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/eureka%20logo.jpg' },
      { name: 'euroqo logo.jpg', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/euroqo%20logo.jpg' },
      { name: 'franke logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/franke%20logo.png' },
      { name: 'hi fi logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/hi%20fi%20logo.png' },
      { name: 'kolors logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/kolors%20logo.png' },
      { name: 'norisys logo.png', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/norisys%20logo.png' },
      { name: 'esses', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/essess.jpg' },
      { name: 'vox', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/vox.png' },
      { name: 'almonard', url: 'https://livinglineswebbucket.blr1.digitaloceanspaces.com/public/almonard.png' }
    ];
    const filtered = brandLogos.filter(brand => brand.name.toLowerCase().includes(searchQuery));
    setBrands(filtered);
  }, [searchQuery]);
